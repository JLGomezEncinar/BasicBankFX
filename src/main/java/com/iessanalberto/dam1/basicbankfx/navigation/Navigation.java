...
import com.iessanalberto.dam1.basicbankfx.screens.ActualizarSaldoScreen;
...
public class Navigation {
    ...
    public static void navigate (String destination, Cliente cliente,String operacion){
        switch (destination){
            case "ActualizarSaldoScreen" -> {
                ActualizarSaldoScreen actualizarSaldoScreen = new ActualizarSaldoScreen(cliente, operacion);
                Scene actualizarSaldoScene = new Scene (actualizarSaldoScreen.getRoot(),320,240);
                stage.setTitle(cliente.getNombre()+ " "+cliente.getApellidos());
                stage.setScene(actualizarSaldoScene);
                stage.show();
            }
        }
    }
